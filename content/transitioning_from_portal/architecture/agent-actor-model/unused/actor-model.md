...
The specific encoding format and schema tooling are covered in the [Implementation](/kb/architecture/agent-actor-model/email-use-case.html) section. For how Agents may be layered on top of this foundation, see [Actor-Agent Architecture](actor-agent.html).

---

## Logical Architecture

This section covers Actor system design. The concrete use case — an organisational email management system — is documented in full in [Email Use Case](/kb/architecture/agent-actor-model/email-use-case.html). The following covers the logical patterns that apply generally.
...
The Protobuf schemas, envelope definition, train protocol, and message type definitions are documented in the [Email Use Case — Implementation](/kb/architecture/agent-actor-model/email-use-case.html) section, where they are grounded in a concrete system.

-->

---

*See also: [Email Use Case](/kb/architecture/agent-actor-model/email-use-case.html) — full worked example applying this model to organisational email management. [Actor-Agent Architecture](actor-agent.html) — how AI Agents may be added externally to this foundation.*

---

| <img src="../../dbj-org-logo.jpg" width="64px" /> 
|---|
