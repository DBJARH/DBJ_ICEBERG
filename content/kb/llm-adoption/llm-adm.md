...
The checks in each phase map to the [DBJ Enterprise Taxonomy](https://method.dbj.org/taxonomy/) levels: Conceptual (Phase A–B), Logical (Phase C), Physical (Phase D), Implementation (Phase E–G).

![TOGAF ADM phases](togaf_adm.png)

For an explanation of what ADM deliverables are, why they matter, and who produces them, see the [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html).
