...
Use this checklist before approving any LLM introduction. It maps to the [4-Level Decision Model](decision-model.html) and follows the [DBJ Enterprise Taxonomy](https://method.dbj.org/taxonomy/) levels: Conceptual, Logical, Physical, Implementation. Every item must be answered "yes" for approval.
