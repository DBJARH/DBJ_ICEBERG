...
chapters: ["method"]
tags: ["llm", "ai-adoption", "governance", "architecture"]
---
...
{{< callout type="note" >}}
Enterprise architecture discipline applied to Large Language Model adoption — a structured framework covering capability justification, governance, and [DBJ ADM integration](https://method.dbj.org/adm/dbj_adm.html).
{{< /callout >}}
...
> 
> Each document applies the  [DBJ ADM integration](https://method.dbj.org/adm/dbj_adm.html) to keep LLM adoption under architectural control.
...
- **[DBJ Enterprise Taxonomy](https://method.dbj.org/taxonomy/)** — a four-level hierarchy (Conceptual, Logical, Physical, Implementation) that structures every architectural decision in the organization.
...
{{< callout type="note" >}}
Remember: DBJ ADM project cycling is simplified vs full TOGAF ADM. See [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html) for the structural foundation that all DBJ ADM wheels follow.
{{< /callout >}}
...
**[The Second-System Effect — Why LLM Adoption Fails](second-system-effect.html)**
...
**[LLM Adoption Decision Model — The 4-Level Test](decision-model.html)**
...
**[EA Governance Checklist — LLM Adoption Control](governance-checklist.html)**
...
**[LLM Governance Integrated into the ADM](llm-adm.html)**
...
**[(Architecture Board) Decision Template — LLM Approval](board-decision-template.html)**
