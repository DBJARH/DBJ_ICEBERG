...
[← How to Document Software Architecture](index.html)
...
Teams working within the [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html) should not adopt arc42 as a documentation structure. The [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html) already defines the documentation scaffold through its phases and deliverables; introducing arc42 alongside it creates two competing structures for the same content. arc42 is designed for teams without a governing ADM — it fills the gap that TOGAF and [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html) already fill here.
...
| Documentation structure and decision hierarchy | [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html) deliverables |
| Code-level traceability (Development only) | DDRs (ADRs repurposed) |

***A minimal viable documentation practice*** within the [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html): C4 Context and Container diagrams for stakeholder communication, [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html) deliverables for decisions and requirements. DDRs are optional and internal to the Development team.
