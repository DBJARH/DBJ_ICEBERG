...
|---|---|---|
| Architecture design and transformation | TOGAF / [ADM](https://method.dbj.org/adm/dbj_adm.html) | *How to change* |
...
The EA team might use ITIL metrics as **input signals** to the [Architecture Development Method (ADM)](https://method.dbj.org/adm/dbj_adm.html):
...
*Framework references: [ITIL 4 Foundation](https://www.axelos.com/certifications/itil-service-management/itil-4-foundation) (AXELOS), [TOGAF 10](https://www.opengroup.org/togaf) (The Open Group), [DBJ ADM](https://method.dbj.org/adm/dbj_adm.html)*
